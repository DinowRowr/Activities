...
$statement = "SELECT t.id, t.abbr, t.name, COUNT(p.id) as total_players 
              FROM teams_tbl t 
...
<div class="container-fluid mt-4">
    <div class="container">
        ...
        <form class="mb-3" action="teams.php" method="GET">
            <div class="d-flex flex-row align-items-center">
                <div class="form-group me-2">
                    <label>Search</label>
                </div>
                <div class="form-group me-2">
                    <input type="text" class="form-control" style="width: 350px;" placeholder="Search team name or abbreviation..."
